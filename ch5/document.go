...
/*
This block of global variables holds the connetion details to the Postres Serer
	Hostname: i te IP or the hostname of the server
...
/*
	DeletUser deletes an existing user if the user exists.
